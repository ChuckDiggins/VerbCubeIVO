...
enum StudentLevel : Int, CaseIterable {
    ...
    public func getLessonObjectives()->(String, String){
        ...
        case .level5002: return ("Some verbs are 'special' and one-of-a-kind.", "These important verbs have their own models.")
        case .level5003: return ("Some verb models are unusual.", "For example, \"unir\" is regular.  \"reunir\" has its own model.")
