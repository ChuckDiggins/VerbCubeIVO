...
//
                ...
                if ( bValidVerb ){
                    VStack {
                        ...
                        VStack{
                            if multipleVerbFlag && languageViewModel.isModelMode() {
                                VStack{
...
//        var msm = languageViewModel.getMorphStructManager()
        vvm.removeAll()
        for i in 0..<6 {
            vvm.append(languageViewModel.getVerbString(personIndex: i, number: number, tense: languageViewModel.getCurrentTense(), specialVerbType: specialVerbType, verbString: currentVerbPhrase, dependentVerb: dependentVerb, residualPhrase: residualPhrase))
