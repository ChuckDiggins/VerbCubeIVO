...
//                        NavigationLink(destination: SimpleVerbConjugation(languageViewModel: languageViewModel, verb: Verb(spanish: currentVerbString, french: currentVerbString, english: currentVerbString), residualPhrase: "", multipleVerbFlag: false)){
//                            HStack{
//                                Text("Show me ")
...
//        let patternList = SpecialPatternType.stemChangingAllSpanish.shuffled()
